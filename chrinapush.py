...
ADB_PATH = "adb"
DOWNLOAD_PATH = path.abspath("./.frida-push")
...
def list_devices():
    ...
    return {
        d[0]: {
            t.split(":")[0]: t.split(":")[1] for t in d[2:] if len(t.split(":"))==2
        } for d in devices
    }
...
def prepare_download_url(arch):
    ...
    base_url = "https://github.91chifun.workers.dev/https://github.com//frida/frida/releases/download/{}/frida-server-{}-android-{}.xz"
